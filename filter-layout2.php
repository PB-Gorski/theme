    ...
    <div class="filter-entry container mx-auto justify-center" data-terms="<?php echo esc_attr($all_terms); ?>">
      ...
      foreach ($result_tax as $tax) {
        ...
        if (get_taxonomy($select_term)->label == 'Cena') { ?>
          ...
          <a href="<?php echo home_url() . '/mieszkania' ?>" class="btn-search btn-wrapper bg-white h-[120px] flex items-center justify-center" style="width:167px;border-bottom:2px solid #ebeef2">
