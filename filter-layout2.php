      ...
      foreach ($result_tax as $tax) {
        ...
        if (get_taxonomy($select_term)->label == 'Cena') { ?>
          ...
          <div class="dropdown-filter customPrice price-max flex-col bg-white">
            ...
            <div class="dropdown__value dropdown__value-price dropdown__value-max font-bold after:content-['']"><span>Max</span><input type="text" id="inputPriceMax" placeholder="Max" class="w-full"></div>
