...
function my_custom_post_layout($layout, $post_id, $filter_id, $increment_post, $arrOptions)
{
	...
	// $layout .= '<p class="w-[100px]">' . get_the_terms($post_id, 'mieszkania') . '</p>';
	// $layout .= '<p class="w-[100px]">' . get_terms($post_id, 'mieszkania') . '</p>';
	$layout .= '<p class="w-[800px]">' . print_r(wp_get_object_terms($post_id, 'mieszkania')) . '</p>';
