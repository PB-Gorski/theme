...
function pb_gorski_blocks_register_styles()
{
	...
	wp_enqueue_script('customJS', get_theme_file_uri('/assets/custom-js.js'), '2.0', array('custom-js', 'tailwind-config'));
	wp_enqueue_script('customJS2', get_theme_file_uri('/assets/frontpage-searching-data-cookies.js'), '2.0', array('frontpage-searching-data-cookies.js', 'tailwind-config'));
	wp_enqueue_script('customJS3', get_theme_file_uri('/assets/lista-mieszkan-page-searching.js'), '2.0', array('lista-mieszkan-page-searching.js', 'tailwind-config'));
	wp_enqueue_script('customJS4', get_theme_file_uri('/assets/o-inwestycji-lista-mieszkan-page-searching.js'), '2.0', array('o-inwestycji-lista-mieszkan-page-searching.js', 'tailwind-config'));
	wp_enqueue_script('customJS5', get_theme_file_uri('/assets/single-mieszkania-cookie-data.js'), '2.0', array('single-mieszkania-cookie-data.js', 'tailwind-config'));
}
