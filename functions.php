...
function pb_gorski_blocks_register_styles()
{
	...
	wp_enqueue_style('google-fonts-roboto', '//fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap', '1.0');
	...
	wp_enqueue_script('customJS2', get_theme_file_uri('/assets/fronpage-searching-data-cookies.js'), '1.0', array('fronpage-searching-data-cookies.js', 'tailwind-config'));
}
