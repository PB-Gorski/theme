...
function pb_gorski_blocks_register_styles()
{
	...
	wp_enqueue_script('customJS', get_theme_file_uri('/assets/custom-js.js'), array(), '2.5.2', array(
		'strategy'  => 'defer',
		'in_footer'  => true,
	));
	wp_enqueue_script('customJS2', get_theme_file_uri('/assets/frontpage-searching-data-cookies.js'),  array('smart-filter-' . wp_create_nonce('smart-filter')), '2.5.2', array(
		'strategy'  => 'defer',
		'in_footer'  => true,
	));
	wp_enqueue_script('customJS3', get_theme_file_uri('/assets/lista-mieszkan-page-searching.js'),  array('smart-filter-' . wp_create_nonce('smart-filter')), '2.5.2', array(
		'strategy'  => 'defer',
		'in_footer'  => true,
	));
	wp_enqueue_script('customJS4', get_theme_file_uri('/assets/o-inwestycji-lista-mieszkan-page-searching.js'), array('smart-filter-' . wp_create_nonce('smart-filter')), '2.5.2', array(
		'strategy'  => 'defer',
		'in_footer'  => true,
	));
	wp_enqueue_script('customJS5', get_theme_file_uri('/assets/single-mieszkania-cookie-data.js'), array('smart-filter-' . wp_create_nonce('smart-filter')), '2.5.2', array(
		'strategy'  => 'defer',
		'in_footer'  => true,
	));
}
