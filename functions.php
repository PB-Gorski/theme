...
function pb_gorski_blocks_register_styles()
{
	...
	wp_enqueue_script('customJS4', get_theme_file_uri('/assets/o-inwestycji-lista-mieszkan-page-searching.js'), array('smart-filter-' . wp_create_nonce('smart-filter')), '2.5.3', array(
		'strategy'  => 'defer',
		'in_footer'  => true,
	));
