  ...
  <div class="wp-block-group container mx-auto h-[100px] flex items-center">
    ...
    <div class="wp-block-group nav-wrapper w-full flex items-center justify-end gap-[20px]">
      ...
      <div class="wp-block-group btn-wrapper-header flex items-center gap-[10px]">
        <!-- wp:group -->
        <div class="wp-block-group group btn-find-more relative bg-transparent flex items-center justify-center border-[2px] border-textGray rounded-full cursor-pointer group relative bg-[#f5f7fa] text-textGray w-full desktop:w-[230px] h-[55px] flex items-center justify-center overflow-hidden before:content-[''] before:inline-block before:z-[-1] before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] hover:text-white before:bg-textGray before:transition-height before:duration-300 before:ease cursor-pointer">
          <!-- wp:paragraph -->
