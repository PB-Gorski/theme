...
<div id="Banner" class="wp-block-group banner h-screen desktop:h-screen">
  ...
  <div class="wp-block-group h-[80%] mx-auto">
    ...
    <div class="wp-block-group h-[80%] w-full">
      <!-- wp:core/video -->
      <figure class="wp-block-video banner-video"><video controls="false" autoplay="true" loop muted preload src="https://www.pbgorski.pl/assets/front/videos/header/hp.mp4?1688121499"></video>
