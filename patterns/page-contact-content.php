  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] py-[50px] desktop:flex gap-[50px]">
    ...
    <div class="wp-block-group left-col desktop:w-[50%]">
      ...
      <div class="wp-block-group section1 mb-[50px]">
        <!-- wp:paragraph -->
        <span class="block text-[30px] text-textGray mb-[30px] font-bold" data-aos="fade-right" data-aos-offset="30">Biuro Sprzedaży Mieszkań / Siedziba Firmy</span>
        <!-- /wp:paragraph -->
        <!-- wp:group -->
      ...
      <div class="wp-block-group section2 mb-[50px]">
        <!-- wp:paragraph -->
        <span class="text-[30px] text-textGray mb-[30px] font-bold" data-aos="fade-right" data-aos-offset="30">Biuro Obsługi Klienta</span>
        <!-- /wp:paragraph -->
        <!-- wp:group -->
        <div class="wp-block-group address mb-[30px] text-[#8a8f99]">
          <!-- wp:paragraph -->
          ...
          <li class="list-content-wrapper transition ease-out duration-[500ms]">
            ...
            <div class="wp-block-group click-bar group flex justify-between items-center cursor-pointer">
              ...
              <div class="wp-block-group bar-title-wrapper text-bgDarkGray flex">
                ...
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="pl-[20px] py-[20px] border-b-[1px] border-[#e8e8e8] font-bold text-[24px] grow font-bold self-center" data-aos="fade-up" data-aos-offset="30">Umowy i akty notarialne</p>
                <!-- /wp:paragraph -->
              </div>
              <!-- /wp:group -->
            </div>
