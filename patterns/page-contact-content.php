          ...
          <ul class="wp-block-list contact-drop-down mt-[50px] ml-0">
            ...
            <li class="list-content-wrapper py-[20px] border-b-[1px] border-[#e8e8e8] transition ease-out duration-[500ms]">
              ...
              <div class="wp-block-group click-bar group flex justify-between items-center cursor-pointer">
                <!-- wp:group -->
                <div class="wp-block-group bar-title-wrapper text-bgDarkGray flex gap-[10px] desktop:gap-[20px] transition ease-out duration-[500ms]">
                  <!-- wp:paragraph -->
                  <p class="w-[22px] pb-[5px] click-bar-icon group-hover:text-primaryYellow uppercase text-[16px] desktop:text-[35px] font-semibold leading-[30px] transition ease-out duration-500">+</p>
                  <!-- /wp:paragraph -->
                  <!-- wp:paragraph -->
                  <p class="bar-title font-bold text-[24px] font-bold self-center transition ease-out duration-[500ms]">Biuro Zarządu</p>
                  <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
              </div>
            ...
            <li class="list-content-wrapper py-[20px] border-b-[1px] border-[#e8e8e8] transition ease-out duration-[500ms]">
              ...
              <div class="wp-block-group click-bar group flex justify-between items-center cursor-pointer">
                ...
                <div class="wp-block-group bar-title-wrapper text-bgDarkGray flex gap-[10px] desktop:gap-[20px]">
                  <!-- wp:paragraph -->
                  <p class="w-[22px] click-bar-icon pb-[5px] group-hover:text-primaryYellow uppercase text-[16px] desktop:text-[35px] font-semibold leading-[30px] transition ease-out duration-500">+</p>
                  <!-- /wp:paragraph -->
                  <!-- wp:paragraph -->
                  <p class="font-bold text-[24px] font-bold self-center">Dział sprzedaży</p>
                  <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
              </div>
            ...
            <li class="list-content-wrapper py-[20px] border-b-[1px] border-[#e8e8e8] transition ease-out duration-[500ms]">
              ...
              <div class="wp-block-group click-bar group flex justify-between items-center cursor-pointer">
                ...
                <div class="wp-block-group bar-title-wrapper text-bgDarkGray flex gap-[10px] desktop:gap-[20px]">
                  ...
                  <!-- /wp:paragraph -->
                  <!-- wp:paragraph -->
                  <p class="bar-titlefont-bold text-[24px] font-bold self-center">Biuro Zarządu</p>
                  <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->
              </div>
