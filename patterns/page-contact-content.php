          ...
          <li class="list-content-wrapper transition ease-out duration-[500ms]">
            ...
            <div class="wp-block-group click-bar group flex justify-between items-center cursor-pointer">
              ...
              <div class="wp-block-group bar-title-wrapper text-bgDarkGray flex gap-[10px] desktop:gap-[20px] transition ease-out duration-[500ms]">
                <!-- wp:paragraph -->
                <p class="w-[22px] pb-[5px] click-bar-icon py-[20px] border-b-[1px] border-[#e8e8e8] group-hover:text-primaryYellow uppercase text-[16px] desktop:text-[35px] font-semibold leading-[30px] transition ease-out duration-500" data-aos="fade-up" data-aos-offset="30">+</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
