        ...
        <ul class="wp-block-list contact-drop-down mt-[50px] ml-0">
          ...
          <li class="list-content-wrapper transition ease-out duration-[500ms]">
            ...
            <div class="wp-block-group click-bar group flex justify-between items-center cursor-pointer">
              <!-- wp:group -->
              <div class="wp-block-group bar-title-wrapper w-full text-bgDarkGray flex gap-[10px] desktop:gap-[20px] transition ease-out duration-[500ms]">
                <!-- wp:paragraph -->
                ...
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="bar-title font-bold grow text-[24px] py-[20px] border-b-[1px] border-[#e8e8e8] font-bold self-center transition ease-out duration-[500ms]" data-aos="fade-up" data-aos-offset="30">Biuro Zarządu</p>
                <!-- /wp:paragraph -->
              </div>
              <!-- /wp:group -->
            </div>
