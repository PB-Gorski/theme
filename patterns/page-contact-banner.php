  ...
  <div class="wp-block-group w-full bg-[#f5f7fa] relative py-[80px]">
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] desktop:pl-[50px]">
      ...
      <div class="wp-block-group text-[#959ba6] text-[30px]">
        ...
        <!-- wp:paragraph -->
        <p class="inline underline hover:text-[#2e384d] transition duration-[300ms] ease">paragraph1 (+48) 58 340 79 00, </p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group links-phones mt-[15px]">
          ...
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
          <p class="inline underline hover:text-[#2e384d] transition duration-[300ms] ease">paragraph2 (+48) 58 340 79 00, </p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
