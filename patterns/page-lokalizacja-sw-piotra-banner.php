...
<div id="Banner" class="wp-block-group page-lokalizacja relative">
  ...
  <div class="wp-block-group w-full h-[250px] desktop:h-[770px] bg-banner relative flex desktop:block items-center">
    ...
    <figure class="wp-block-image w-full h-full absolute top-0 left-0">
      <img src="<?php echo home_url(); ?>/wp-content/themes/pbgorski/assets/img/page-o-inwestycji/lokalizacja-bg.jpeg" alt="banner-background">
    </figure>
    <!-- /wp:image -->
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] desktop:pl-[80px] z-[0] relative text-white">
      ...
      <div class="wp-block-group title text-[36px] desktop:text-[60px] desktop:pt-[290px] mb-[50px] leading-[44px] desktop:leading-[70px]">
        <!-- wp:paragraph -->
        <p class="font-bold underline underline-offset-[20px]" data-aos="fade-right" data-aos-offset="30">Lokalizacja</p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p class="uppercase text-[18px] trancking-[10px]" data-aos="fade-right" data-aos-offset="30">Lorem ipsum</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
