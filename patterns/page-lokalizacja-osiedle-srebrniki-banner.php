...
<div id="Banner" class="wp-block-group page-lokalizacja relative">
  <!-- wp:group -->
  <div class="wp-block-group w-full h-[50vh] desktop:h-[80vh] bg-banner relative flex desktop:block items-center">
    <!-- wp:group -->
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] z-[2] relative text-white">
      ...
      <div class="wp-block-group title text-[36px] desktop:text-[60px] desktop:pt-[290px] mb-[50px] leading-[44px] desktop:leading-[70px]">
        <!-- wp:heading {"level":1} -->
        <h1><span class="block font-bold" data-aos="fade-right" data-aos-offset="30">Gdańsk - Srebrniki</span></h1>
        <!-- /wp:heading -->
      </div>
      <!-- /wp:group -->
    </div>
