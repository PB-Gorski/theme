  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px] pt-[140px] pb-[100px]">
    ...
    <div class="wp-block-group two-col-layout desktop:mb-[30px] mb-[80px] desktop:flex justify-center desktop:px-[50px]">
      ...
      <div class="wp-block-group right-col desktop:w-[40%] desktop:pl-[40px] desktop:pt-[50px] pt-0">
        ...
        <!-- /wp:group -->
        <!-- wp:group -->
        <div class="wp-block-group group btn-find-more relative bg-[#3d4b66] text-white w-full desktop:w-[230px] h-[55px] flex items-center justify-center border-b-black before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer">
          <!-- wp:paragraph -->
          <p class="font-bold z-[1]"><a href="#cta2">Zapytaj o mieszkanie</a></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
