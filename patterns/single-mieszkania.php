...
<div id="Wpis" class="wp-block-group mieszkania-page-post ooverflow-hidden relative">
  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px] pt-[140px] pb-[100px]">
    <!-- wp:paragraph -->
    <p class="mb-[60px] desktop:text-[24px] font-medium">Przykładowa aranżacja <span class="text-[#828894] desktop:text-[24px] text-[18px]">(kliknij zdjęcie by powiększyć)</span></p>
    <!-- /wp:paragraph -->
