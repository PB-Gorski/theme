...
/**
 * Title: o-inwestycji-sw-piotra-banner
 * Slug: o-inwestycji-sw-piotra-banner
...
<div id="Banner" class="wp-block-group banner h-[50vh] desktop:h-[90vh] relative">
  <!-- wp:group -->
  <div class="wp-block-group banner-lista-mieszkan w-full h-full bg-banner relative flex desktop:block items-center overflow-hidden">
    <!-- wp:group -->
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] z-[2] relative text-white">
      ...
      <div class="wp-block-group title text-[36px] desktop:text-[60px] desktop:pt-[290px] mb-[50px] leading-[44px] desktop:leading-[70px]">
        <!-- wp:paragraph -->
        <span class="block font-bold underline underline-offset-[20px]" data-aos="fade-right" data-aos-offset="30">Św. Piotra</span>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <span class="block uppercase text-[18px] trancking-[10px]" data-aos="fade-right" data-aos-offset="30">Gdynia</span>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
