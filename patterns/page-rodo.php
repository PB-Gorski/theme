...
<div id="rodo" class="wp-block-group rodo relative">
  ...
  <div class="wp-block-group mb-[90px] title w-full bg-[#f5f7fa] relative py-[80px]">
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px]">
      ...
      <div class="wp-block-group title text-[36px] desktop:text-[60px] font-bold mb-[50px] leading-[50px] desktop:leading-[70px]">
        <!-- wp:heading {"level":1} -->
        <h1><span class="desktop:block inline" data-aos="fade-right" data-aos-offset="30">OCHRONA DANYCH OSOBOWYCH</span></h1>
        <!-- /wp:heading {"level":1} -->
      </div>
      <!-- /wp:group -->
    </div>
  ...
  <div class="wp-block-group content container mx-auto max-w-[900px] desktop:px-0 px-[20px]">
    ...
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Przedsiębiorstwo Budowlane Górski wyznaczyło Inspektora ochrony danych w osobie pana Marcina Sokoła. W razie jakichkolwiek wątpliwości związanych z przetwarzaniem dotyczących Państwa danych osobowych, prosimy o kontakt z Inspektorem ochrony danych, listownie na adres Przedsiębiorstwa Budowlanego Górski z dopiskiem „Inspektor Ochrony Danych”, bądź na adres e-mail: iod@pbgorski.pl.</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    ...
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[20px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Przedsiębiorstwo Budowlane Górski przetwarza powierzone przez Państwa dane osobowe tzn. w szczególności zbiera je, utrwala, przechowuje, usuwa lub niszczy. Państwa dane osobowe są przetwarzane w następujących celach:</p>
    <!-- /wp:paragraph -->
    <!-- wp:list -->
    ...
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Przedsiębiorstwo Budowlane Górski bez zbędnej zwłoki – nie później niż w terminie miesiąca od dnia wpłynięcia wniosku – udzieli osobie, której dane dotyczą, informacji o działaniach podjętych w związku z realizacją powyższych praw.</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Termin miesięczny może ulec przedłużeniu o kolejne dwa miesiące z uwagi na skomplikowany charakter wniosku lub liczbę wniosków. W takim przypadku Przedsiębiorstwo Budowlane Górski w terminie miesiąca od otrzymania wniosku, poinformuje osobę, której dane dotyczą, o takim przedłużeniu terminu z podaniem przyczyn opóźnienia.</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Wniosek powinien w miarę możliwości precyzyjnie wskazywać, czego dotyczy żądanie, tj. w szczególności:</p>
    <!-- /wp:paragraph -->
    ...
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Informujemy, że jeżeli Administrator nie będzie w stanie ustalić treści żądania lub zidentyfikować osoby składającej wniosek w oparciu o dokonane zgłoszenie, zwróci się do wnioskodawcy o dodatkowe informacje.</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Odpowiedź będzie udzielana na adres e-mail, z którego przesłano wniosek, a w przypadku wniosków skierowanych listownie, listem poleconym na adres wskazany przez wnioskodawcę, o ile z treści listu nie będzie wynikała chęć otrzymania informacji zwrotnej na adres e-mail (w takim przypadku należy podać adres e-mail).</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">W przypadku wątpliwości co do prawidłowości przetwarzania Państwa danych osobowych przez Przedsiębiorstwo Budowlane Górski mają Państwo prawo wniesienia skargi do organu nadzorczego zajmującego się ochroną danych osobowych, to jest Prezesa Urzędu Ochrony Danych Osobowych.</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Naszym celem jest zawsze zachować prywatność i bezpieczeństwo danych, a także kontrolować przetwarzanie wszystkich powierzonych nam przez Państwa danych.</p>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Administrator na bieżąco prowadzi analizę ryzyka w celu zapewnienia, że dane osobowe przetwarzane są przez niego w sposób bezpieczny – zapewniający przede wszystkim, że dostęp do danych mają jedynie osoby upoważnione i jedynie w zakresie, w jakim jest to niezbędne ze względu na wykonywane przez nie zadania służbowe.</p>
    <!-- /wp:paragraph -->
