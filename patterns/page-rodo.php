...
<div id="rodo" class="wp-block-group rodo relative">
  ...
  <div class="wp-block-group content container mx-auto desktop:px-0 px-[20px]">
    ...
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <p class="mb-[30px] text-[18px] text-bgDarkGray leading-[30px]" data-aos="fade-right" data-aos-offset="30">Z Administratorem danych (i współadministratorem) może się Pani/Pan skontaktować: listownie na adres: (80-442) Gdańsk ul. <span class="text-textGray">Joachima Lelewela 37 lok. E.</span></p>
    <!-- /wp:paragraph -->
