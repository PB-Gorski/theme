...
<div id="Content" class="wp-block-group content relative">
  ...
  <div class="wp-block-group row-content3 desktop:flex">
    ...
    <div class="wp-block-group p-[140px_100px] w-1/2">
      ...
      <!-- /wp:paragraph -->
      <a href="<?php echo home_url() . '/lokalizacja'; ?>" class="inline relative text-textGray before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[50%] hover:before:min-h-[100%] before:bg-[#b3f1ff] before:transition-height before:duration-300 before:ease before:z-[-1] cursor-pointer">Więcej o lokalizacji &rarr;</a>
    </div>
    <!-- /wp:group -->
