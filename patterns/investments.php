...
<div id="inwestycje" class="wp-block-group inwestycje mb-[150px] relative">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    ...
    <ul class="wp-block-list inwestycje-posts mb-[40px] flex desktop:flex-row flex-col justify-between gap-[30px]">
      ...
      ?>
          <!-- wp:list-item -->
          <li class="invest-tile max-w-full mb-[80px] w-full" data-aos="fade-up" data-aos-duration="500" data-aos-offset="30" data-aos-delay="<?php echo $counter * 50; ?>">
            <a href="<?php echo home_url() . '/o-inwestycji' ?>">
              <!-- wp:group -->
