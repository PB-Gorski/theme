...
<div id="inwestycje" class="wp-block-group inwestycje desktop:mb-[150px] mb-[80px] relative">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    ...
    <!-- wp:paragraph -->
    <a href="<?php echo home_url() . '/inwestycje' ?>" class="wp-block-group desktop:absolute bottom-[-70px] left-[50%] translat-x-[-50%]" data-aos="fade-right" data-aos-duration="500" data-aos-offset="30">
      <!-- wp:group -->
