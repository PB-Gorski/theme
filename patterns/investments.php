...
<div id="inwestycje" class="wp-block-group inwestycje desktop:mb-[150px] mb-[80px] relative">
  <!-- wp:group -->
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    <!-- wp:group -->
    <div class="wp-block-group pt-[60px] pb-[30px] desktop:pb-[40px] title">
      <!-- wp:paragraph -->
      <p data-aos="fade-right" data-aos-duration="500" data-aos-offset="30" class="text-[24px] text-center text-bgDarkGray">Poznaj nasze najnowsze inwestycje</p>
      <!-- /wp:paragraph -->
      <!-- wp:group -->
    ...
    <!-- wp:paragraph -->
    <a href="<?php echo home_url() . '/inwestycje' ?>" class="wp-block-group desktop:absolute bottom-[-70px] left-[40%]" data-aos="fade-right" data-aos-duration="500" data-aos-offset="30">
      <!-- wp:group -->
