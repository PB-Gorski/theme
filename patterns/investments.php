...
<div id="inwestycje" class="wp-block-group inwestycje bg-white mb-[80px] relative z-[0]">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    ...
    <ul class="wp-block-list inwestycje-posts mb-[40px] flex desktop:flex-row flex-col justify-between desktop:gap-[30px] gap-y-[30px] desktop:gap-y-auto">
      ...
      ?>
          ...
          <li class="invest-tile max-w-full w-full inline-block">
            <a href="<?php echo home_url() . '/o-inwestycji-' . $alias; ?>" class="inline-block w-full" data-aos="fade-up" data-aos-offset="30" data-aos-delay="<?php echo $counter * 50; ?>">
              <!-- wp:group -->
    ...
    <div class="wp-block-group flex items-center justify-center">
      <!-- wp:group -->
      <div class="wp-block-group btn-find-more relative w-fit h-[55px] p-[10px_20px] bg-[#3d4b66] text-white flex items-center justify-center border-b-[2px] border-b-[#2e384d] before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer">
        <!-- wp:paragraph -->
