  ...
  <div class="wp-block-group w-full h-full bg-banner relative flex desktop:block items-center">
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] z-[0] relative text-white">
      ...
      <div class="wp-block-group desktop:flex">
        <!-- wp:group -->
        <div class="wp-block-group col1 desktop:pl-0 pr-[40px] w-fit h-[68px] flex gap-[25px] desktop:gap-[15px] items-center border-r-[1px] border-[rgba(255,255,255,0.2)]">
          <!-- wp:paragraph -->
        ...
        <!-- /wp:group -->
        <!-- wp:group -->
        <div class="wp-block-group col2 desktop:px-[20px] w-fit h-[68px] flex gap-[25px] desktop:gap-[15px] items-center desktop:border-r-[1px] desktop:border-[rgba(255,255,255,0.2)]">
          <!-- wp:paragraph -->
        ...
        <!-- /wp:group -->
        <!-- wp:group -->
        <div class="wp-block-group col3 desktop:px-[20px] w-fit h-[68px] flex gap-[25px] desktop:gap-[15px] items-center">
          <!-- wp:paragraph -->
