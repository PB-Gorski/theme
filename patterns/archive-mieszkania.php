...
<div id="content" class="wp-block-group content relative ">
  ...
  <div class="wp-block-group bg-bgLightGray">
    <!-- wp:group -->
    <div class="wp-block-group search-wrapper relative mx-auto py-[20px] px-[20px] desktop:h-[102px] text-[18px] flex flex-col desktop:flex-row gap-[10px] desktop:gap-[1px] overflow-y-hidden transition-height duration-[400ms] ease">
      <!-- wp:group -->
