  ...
  <div class="wp-block-group">
    ...
    <div class="wp-block-group title-wrapper bg-[#f6f7fa]">
      ...
      <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
        ...
        <!-- wp:paragraph -->
        <p>taxonomy-osiedla-angielska-grobla</p>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group">
          ...
          <ul class="wp-block-list container mx-auto desktop:px-0 px-[20px] pb-[50px] flex items-center gap-[20px] text-[18px] font-medium">
            ...
            ?>
              <!-- wp:list-item -->
              <li class="CityTabBtn text-[#959ba6] hover:text-textGray hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-primaryRed cursor-pointer <?php (($taxonomy->name) == 'Angielska Grobla') ? 'tab-active' : 'false'; ?>"><a href="<?php echo get_category_link($taxonomy->term_id) ?>" class=""><?php echo $taxName; ?></a></li>
              <!-- /wp:list-item -->
            <?php }; ?>
          </ul>
          <!-- /wp:list -->
