...
/**
 * Title: taxonomy-osiedla-angielska-grobla
 * Slug: taxonomy-osiedla-angielska-grobla
...
<div id="Wpis" class="wp-block-group taxonomy-osiedla-angielska-grobla mb-[150px] ooverflow-hidden">
  <!-- wp:group -->
  <div class="wp-block-group">
    ...
    <div class="wp-block-group title-wrapper bg-[#f6f7fa]">
      ...
      <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
        <!-- wp:paragraph -->
        <a href="/aktualnosci/" class="group w-fit font-semibold flex items-center gap-[8px]">
          <!-- wp:group -->
        ...
        <div class="wp-block-group">
          <!-- wp:paragraph -->
          <p class="container mx-auto desktop:px-0 px-[20px] mb-[40px] text-[60px] text-[#2e384c] font-bold">Aktualności - Angielska Grobla</p>
          <!-- /wp:paragraph -->
          ...
          <ul class="wp-block-list container mx-auto desktop:px-0 px-[20px] pb-[50px] flex items-center gap-[20px] text-[18px] font-medium">
            ...
            ?>
              <!-- wp:list-item -->
              <li class="CityTabBtn text-[#959ba6] hover:text-textGray hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-primaryRed cursor-pointer <?php echo ($taxName == 'Angielska Grobla') ? 'tab-active' : ''; ?>"><a href="<?php echo get_category_link($taxonomy->term_id) ?>" class=""><?php echo $taxName; ?></a></li>
              <!-- /wp:list-item -->
            <?php }; ?>
          </ul>
          <!-- /wp:list -->
