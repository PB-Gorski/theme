    ...
    <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
      ...
      <div class="wp-block-group">
        ...
        <div class="flex flex-wrap gap-[20px]">
          <span>
            <?php echo the_ID(); ?>
            <a href="<?php echo get_home_url() . '/blog'; ?>" class="inline-block allTabBtn text-[#8A8F99] <?php echo is_page(1817) ? 'blog' : 'not blog'; ?> hover:text-textGray hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-primaryRed cursor-pointer">Wszystkie</a>
          </span>
