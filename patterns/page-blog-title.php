    ...
    <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
      ...
      <div class="wp-block-group">
        ...
        <div class="flex flex-wrap gap-[20px]">
          <span>
            <a href="<?php echo get_home_url() . '/blog'; ?>" class="inline-block allTabBtn text-[#8A8F99] hover:text-textGray hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-primaryRed cursor-pointer" data-aos="fade-right" data-aos-offset="30">Wszystkie</a>
          </span>
