...
<div id="Banner" class="wp-block-group banner-lista-mieszkan-wiezycka-folwark banner-lista-mieszkan relative">
  <!-- wp:group -->
  <div class="wp-block-group w-full h-[480px] desktop:h-[600px] relative py-[60px]">
    ...
    <!-- /wp:image -->
    <!-- wp:group -->
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] desktop:pt-[100px] relative z-[2]">
      <!-- wp:group -->
