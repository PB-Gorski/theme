...
/**
 * Title: lokalizacja-sukiennicza-19a-banner
 * Slug: lokalizacja-sukiennicza-19a-banner
  ...
  <div class="wp-block-group w-full h-[250px] desktop:h-[770px] bg-banner relative flex desktop:block items-center">
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] z-[2] relative text-white">
      ...
      <div class="wp-block-group title text-[36px] desktop:text-[60px] desktop:pt-[290px] mb-[50px] leading-[44px] desktop:leading-[70px]">
        <!-- wp:heading {"level":1} -->
        <h1><span class="block font-bold" data-aos="fade-right" data-aos-offset="30">Gdańsk Śródmieście - zamieszkaj w centrum miasta</span></h1>
        <!-- /wp:heading -->
      </div>
      <!-- /wp:group -->
    </div>
