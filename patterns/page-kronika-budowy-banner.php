...
/**
 * Title: kronika-budowy-banner
 * Slug: kronika-budowy-banner
...
<div id="Banner" class="wp-block-group page-kronika-budowy-banner test relative">
  <!-- wp:group -->
  ...
  <!-- wp:group -->
  <div class="wp-block-group w-full bg-banner relative flex desktop:block items-center">
    <!-- wp:image -->
