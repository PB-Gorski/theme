...
<div id="Content" class="wp-block-group content relative">
  ...
  <div class="wp-block-group row-content-container px-[20px] desktop:px-0">
    ...
    <div class="wp-block-group row-content desktop:flex">
      <!-- wp:group -->
      <div class="wp-block-group block cursor-default left-col desktop:w-1/2 m-0 mb-[20px] desktop:mb-0 mb-[20px] desktop:mb-0" data-aos="fade-right" data-aos-offset="30">
        <!-- wp:image -->
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:px-[100px] desktop:w-1/2">
        <!-- wp:paragraph -->
        <span class="mb-[40px] text-[30px] desktop:text-[34px] leading-[36px] desktop:leading-[44px]" data-aos="fade-right" data-aos-offset="30">Św. Piotra to luksusowy apartamentowiec oferujący pełen komfort życia, położony w samym sercu Gdyni - nieopodal Placu Kaszubskiego.</span>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group mb-[100px] desktop:grid grid-rows-2 grid-cols-2 gap-[30px]">
          ...
          <div class="wp-block-group info-box1 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">Gdynia</span>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
          ...
          <div class="wp-block-group info-box2 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">I kwartał 2023</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box3 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">227</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box4 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">24 m<sup>2</sup> - 107 m<sup>2</sup></span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
        </div>
