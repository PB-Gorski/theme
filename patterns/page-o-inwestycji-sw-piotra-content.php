      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:px-[100px] desktop:w-1/2">
        ...
        <div class="wp-block-group mb-[30px] desktop:mb-[100px] desktop:grid grid-rows-2 grid-cols-2 gap-[30px]">
          ...
          <div class="wp-block-group info-box1 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:heading -->
            <!-- wp:heading {"level":5} -->
            <h5><span class="investCity block text-[24px]" data-aos="fade-right" data-aos-offset="30">Gdynia</span></h5>
            <!-- /wp:heading -->
            <!-- wp:paragraph -->
          ...
          <div class="wp-block-group info-box2 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:heading -->
            <!-- wp:heading {"level":5} -->
            <h5><span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">I kwartał 2023</span></h5>
            <!-- /wp:heading -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box3 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:heading -->
            <!-- wp:heading {"level":5} -->
            <h5><span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">227</span></h5>
            <!-- /wp:heading -->
          </div>
          <!-- /wp:group -->
