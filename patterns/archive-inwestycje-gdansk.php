...
<div id="inwestycje-archive" class="wp-block-group inwestycje-archive relative">
  ...
  <div class="wp-block-group inwestycje-posts container mx-auto desktop:px-0 px-[20px]">
    ...
    <!-- wp:paragraph -->
    <p class="mb-[50px] text-[24px] text-center" data-aos="fade-up" data-aos-offset="30">Znaleziono <?php echo $count; ?> oferty pasujących do Twoich kryteriów <span class="text-[16px] text-[#8a8f99]">(wszystkich ogłoszeń <?php echo wp_count_posts('mieszkania')->publish; ?>)</span></p>
    <!-- /wp:paragraph -->
