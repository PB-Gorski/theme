...
<div id="cta2" class="wp-block-group cta2 h-[560px] desktop:h-fit relative">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] h-full flex">
    ...
    <div class="wp-block-group col2 w-[100%] desktop:w-[55%] py-[60px] fflex flex-col gap-[30px] items-center jusify-center">
      ...
      <!-- wp:paragraph -->
      <span class="group btn-find-more block relative bg-[#3d4b66] text-white w-[210px] h-[55px] flex items-center justify-center border-b-[3px] border-b-[#95102b] before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#95102b] before:transition-height before:duration-300 before:ease cursor-pointer" data-aos="fade-right" data-aos-offset="30"><span class="font-bold text-white z-[1]"><a href="<?php echo home_url() . '/contact' ?>"> Wyślij</a></span></span>
      <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
