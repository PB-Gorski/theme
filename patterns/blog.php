...
<div id="blog" class="wp-block-group blog">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    ...
    <a href="<?php echo home_url() . '/blog' ?>" class="wp-block-group" data-aos="fade-right" data-aos-duration="500" data-aos-offset="30">
      <!-- wp:group -->
      <div class="wp-block-group btn-find-more relative bg-[#3d4b66] text-white w-fit h-[55px] flex items-center justify-center before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer">
        <!-- wp:paragraph -->
