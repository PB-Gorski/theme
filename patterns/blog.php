...
<div id="blog" class="wp-block-group blog h-[600pxpx]">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
          ...
          <li class="blog-tile w-full inline-block group">
            <a href="<?php the_permalink(); ?>" class="relative group inline-block" data-aos="fade-up" data-aos-offset="30" data-aos-delay="<?php echo $counter2 * 50; ?>">
              ...
              <div class="wp-block-group wrapper">
                ...
                <!-- wp:paragraph -->
                <p class="relative inline text-primaryRed before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[50%] group-hover:before:min-h-[100%] before:bg-lightBlue before:transition-height before:duration-300 before:ease before:z-[-1] cursor-pointer"> &#x25BA;</p>
                <!-- /wp:paragraph -->
              </div>
              <!-- /wp:group -->
            </a>
    ...
    <!-- /wp:list -->
    <!-- wp:paragraph -->
    <a href="<?php echo home_url() . '/blog' ?>" class="wp-block-group desktop:absolute bottom-[-70px] left-[50%] translate-x-[-50%]" data-aos="fade-right" data-aos-duration="500" data-aos-offset="30">
      <!-- wp:group -->
      <div class="wp-block-group btn-find-more relative bg-[#3d4b66] text-white desktop:w-[315px] w-full h-[55px] flex items-center justify-center before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer">
        <!-- wp:paragraph -->
