          ...
          <li class="blog-tile w-full inline-block group">
            <a href="<?php the_permalink(); ?>" class="relative group inline-block" data-aos="fade-up" data-aos-offset="30" data-aos-delay="<?php echo $counter2 * 50; ?>">
              ...
              <div class="wp-block-group wrapper">
                ...
                <!-- wp:paragraph -->
                <p class="relative inline before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[50%] group-hover:before:min-h-[100%] before:bg-lightBlue before:transition-height before:duration-300 before:ease before:z-[-1] cursor-pointer">Czytaj dalej &#25BA;</p>
                <!-- /wp:paragraph -->
              </div>
              <!-- /wp:group -->
            </a>
