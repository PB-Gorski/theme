...
<div id="blog" class="wp-block-group blog h-[600pxpx]">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group title">
      <!-- wp:paragraph -->
      <p data-aos="fade-right" data-aos-duration="500" data-aos-offset="30" class="text-[24px] desktop:ml-[100px] text-bgDarkGray">Aktualności</p>
      <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <ul class="wp-block-list mb-[40px] flex desktop:flex-row flex-col justify-between gap-[30px]">
      ...
      ?>
          ...
          <li class="blog-tile w-full">
            <a href="<?php the_permalink(); ?>" class="relative group p-[25px]" data-aos="fade-up" data-aos-offset="30">
              <!-- wp:group -->
