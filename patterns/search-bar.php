...
<div id="search-bar" class="wp-block-group search-bar h-[115px] bg-bgLightGray py-[25px] transition-height duration-[300ms] ease-linear">
  <!-- wp:group -->
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] text-[18px] flex gap-[1px]">
    ...
    <!-- wp:group -->
    <div class="wp-block-group group btn-search relative bg-primaryRed text-white w-[245px] h-[65px] flex items-center justify-center gap-[15px] before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-btnHoverRed before:transition-height before:duration-300 before:ease cursor-pointer">
      <!-- wp:paragraph -->
