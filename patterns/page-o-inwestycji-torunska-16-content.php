...
/**
 * Title: o-inwestycji-torunska-16-content
 * Slug: o-inwestycji-torunska-16-content
...
<div id="Content" class="wp-block-group content relative">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    <!-- wp:paragraph -->
    <span class="block py-[30px] desktop:py-0 desktop:pt-[60px] text-[36px] desktop:text-[60px] text-center font-bold" data-aos="fade-right" data-aos-offset="30">Toruńska 16</span>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <span class="block pb-[30px] desktop:pb-[60px] text-[20px] text-[#8a8f99] desktop:text-[24px] text-center" data-aos="fade-right" data-aos-offset="30">Kameralna inwestycja zlokalizowana w Śródmieściu Gdańska</span>
    <!-- /wp:paragraph -->

    <!-- wp:group -->
    <div class="wp-block-group test row-links mb-[50px] flex flex-wrap justify-center items-center gap-[20px]">
      <!-- wp:paragraph -->
      <a href="<?php echo home_url() . '/o-inwestycji-torunska-16' ?>" data-aos="fade-up" data-aos-offset="30">O inwestycji</a>
      <!-- /wp:paragraph -->
      <!-- wp:paragraph -->
      ...
      <!-- /wp:paragraph -->
      <!-- wp:paragraph -->
      <a href="<?php echo home_url() . '/lista-mieszkan-torunska-16' ?>" class="text-[#8a8f99] hover:text-textGray" data-aos="fade-up" data-aos-offset="30">Lista mieszkań</a>
      <!-- /wp:paragraph -->
      <!-- wp:paragraph -->
  ...
  <div class="wp-block-group row-content-container px-[20px] desktop:px-0">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:px-[100px] desktop:w-1/2 flex flex-col justify-center">
        ...
        <div class="wp-block-group mb-[30px] desktop:mb-[100px] desktop:mb-0 desktop:grid grid-rows-2 grid-cols-2 gap-[30px]">
          ...
          <div class="wp-block-group info-box1 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">Gdańsk Śródmieście</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box2 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">II kwartał 2024</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box3 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">29</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box4 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">31 m<sup>2</sup> - 97 m<sup>2</sup></span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
        </div>
    ...
    <div class="wp-block-group row-content4 desktop:flex flex-row-reverse">
      ...
      <!-- wp:paragraph -->
      <span class="group btn-find-more block relative mb-[40px] px-[20px] bg-[#3d4b66] text-white w-fit h-[55px] flex items-center justify-center before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer" data-aos="fade-right" data-aos-offset="30"><span class="font-bold text-white z-[1]"><a href="<?php echo home_url() . '/mieszkania'; ?>">Wyszukaj mieszkanie</a></span></span>
      <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
  </div>
