  ...
  <div class="wp-block-group row-content-container px-[20px] desktop:px-0 max-w-[1620px] mx-auto">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:px-[100px] desktop:w-1/2 flex flex-col justify-center">
        ...
        <div class="wp-block-group mb-[30px] desktop:mb-[100px] desktop:mb-0 desktop:grid grid-rows-2 grid-cols-2 gap-[30px]">
          ...
          <div class="wp-block-group info-box2 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:heading -->
            <!-- wp:heading {"level":5} -->
            <h5><span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">II kwartał 2024</span></h5>
            <!-- /wp:heading -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box4 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:heading -->
            <!-- wp:heading {"level":5} -->
            <h5><span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">31 m<sup>2</sup> - 97 m<sup>2</sup></span></h5>
            <!-- /wp:heading -->
          </div>
          <!-- /wp:group -->
        </div>
    ...
    <div class="wp-block-group row-content4 desktop:flex flex-row-reverse">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:p-[140px_100px] desktop:w-1/2">
        ...
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p class="group btn-find-more block relative mb-[40px] px-[20px] bg-[#3d4b66] text-white w-fit h-[55px] flex items-center justify-center border-b-[3px] border-b-[#2e384d] before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer" data-aos="fade-right" data-aos-offset="30"><span class="font-bold text-white z-[1]"><a href="<?php echo home_url() . '/mieszkania'; ?>">Wyszukaj mieszkanie</a></span></p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
