...
<div id="Banner" class="wp-block-group banner-lista-mieszkan-default relative">
  <!-- wp:group -->
    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] desktop:pt-[100px]">
      ...
      <div class="wp-block-group title-wrapper">
        ...
        <div class="wp-block-group sub-title text-[24px] text-[#8a8f99]">
          <!-- wp:paragraph -->
          <p class="max-w-[550px] text-white opacity-[0.75]"><span data-aos="fade-right" data-aos-offset="30">Określ parametry, aby znaleźć mieszkanie dokładnie takie, jakiego potrzebujesz.</span></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
