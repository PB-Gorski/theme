  ...
  <li>
    <a href="<?php home_url(); ?>" class="logo">
      ...
      <figure class="wp-block-image w-[115px]">
        <img src="https://mutiny.webo.design/wp-content/themes/mutiny/assets/img/frontpage/logo.png" alt="pb-gorski-logo" />
      </figure>
      <!-- /wp:image -->
    </a>
  </li>
    ...
    <p>
      <a href="/" class="w-[35px] h-[27px] fixed top-[15px] left-[20px]">
        ...
        <figure class="wp-block-image menu-logo desktop:hidden mr-[10px]">
          <img src="/wp-content/themes/mutiny/assets/img/frontpage/logo.png" alt="pb-gorski-logo" />
        </figure>
        <!-- /wp:image -->
      </a>
    </p>
