...
<div id="Menu-desktop" class="wp-block-group nav-desktop relative">
  ...
  <div class="wp-block-group container mx-auto h-[100px] flex items-center">
    ...
    <div class="wp-block-group nav-wrapper w-full flex items center justify-between gap-[20px]">
      ...
      <!-- wp:group -->
      <div class="wp-block-group modal w-full h-[209px] py-[20px] bg-bgLightGray opacity-100 absolute top-[100px] left-0 z-[0] test transition ease duration-300">
        <!-- wp:group -->
        <div class="wp-block-group container mx-auto">
          ...
          <ul class="wp-block-list mb-[20px] flex items-center gap-[20px] text-[14px] font-medium">
            <!-- wp:list-item -->
            <li class="uppercase allTabBtn text-[#8A8F99] hover:text-textGray hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-primaryRed cursor-pointer">
              WSZYSTKIE
            </li>
            <!-- /wp:list-item -->
            <!-- wp:list-item -->
