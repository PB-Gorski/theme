  ...
  <div class="wp-block-group container mx-auto h-[100px] flex items-center text-white">
    ...
    <div class="wp-block-group nav-wrapper w-full flex items-center justify-end gap-[20px]">
      ...
      <div class="wp-block-group btn-wrapper-header flex items-center gap-[10px]">
        <!-- wp:group -->
        <div class="wp-block-group group btn-find-more relative bg-transparent text-white p-[15px] flex items-center justify-center border-[2px] border-white rounded-full cursor-pointer overflow-hidden before:content-[''] before:inline-block before:z-[-1] before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] hover:text-textGray before:bg-white before:transition-height before:duration-300 before:ease ">
          <!-- wp:paragraph -->
          <a href="<?php echo home_url() . '/mieszkania'; ?>" class="z-[1] h-full w-full flex items-center justify-center">Znajdź mieszkanie</a>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        <!-- wp:group -->
...
<div id="Mobile" class="wp-block-group nav-mobile h-[80px] bg-white text-textGray block desktop:hidden container mx-auto px-[20px] transition ease-out duration-300">
  ...
  <div class="wp-block-group h-full flex justify-between items-center relative z-[4]">
    ...
    <div class="wp-block-group header-right-col flex">
      <!-- wp:group -->
      <div class="wp-block-group group btn-call-header-mobile relative bg-transparent text-primaryRed w-[48px] h-[48px] flex items-center justify-center border-[2px] border-primaryRed rounded-full cursor-pointer transition duration-[300ms] ease">
        <!-- wp:paragraph -->
        <a href="<?php echo home_url() . '/contact' ?>">
          <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#b22944" height="28px" width="28px" version="1.1" id="Capa_1" viewBox="0 0 482.6 482.6" xml:space="preserve">
            <g>
