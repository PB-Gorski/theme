    ...
    <ul class="wp-block-list mb-[40px]">
      ...
      ?>
        ...
        <li class="invest-tile max-w-full test desktop:h-[450px] mb-[80px]">
          <a href="<?php echo home_url() . '/o-inwestycji-' . $taxNoSpaces2; ?>" class="relative group inline-block cursor-default desktop:max-w-full w-full h-full" data-aos="fade-up" data-aos-offset="30">
            <!-- wp:group -->
