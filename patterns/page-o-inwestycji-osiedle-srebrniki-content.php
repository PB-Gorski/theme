  ...
  <div class="wp-block-group row-content-container px-[20px] desktop:px-0">
    ...
    <div class="wp-block-group row-content desktop:flex">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:px-[100px] desktop:w-1/2">
        ...
        <!-- wp:group -->
        <div class="wp-block-group mt-[40px] mb-[100px] desktop:grid grid-rows-2 grid-cols-2 gap-[30px]">
          <!-- wp:group -->
          ...
          <div class="wp-block-group info-box4 mb-[35px] desktop:mb-[30px]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="block text-[24px]" data-aos="fade-right" data-aos-offset="30">27 m<sup>2</sup> - 113 m<sup>2</sup></span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
        </div>
    ...
    <div class="wp-block-group row-content2 desktop:flex flex-row-reverse">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:p-[140px_100px] desktop:w-1/2">
        <!-- wp:paragraph -->
        <span class="block mb-[40px] text-[30px] desktop:text-[34px] leading-[36px] desktop:leading-[44px]" data-aos="fade-right" data-aos-offset="30">Postaw na nowoczesną architekturę</span>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
    ...
    <div class="wp-block-group row-content3 desktop:flex">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:p-[140px_100px] desktop:w-1/2">
        <!-- wp:paragraph -->
        <span class="block mb-[40px] text-[30px] desktop:text-[34px] leading-[36px] desktop:leading-[44px]" data-aos="fade-right" data-aos-offset="30">Zielona enklawa w doskonałej lokalizacji</span>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
