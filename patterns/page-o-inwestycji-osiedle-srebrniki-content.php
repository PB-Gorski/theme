...
<div id="Content" class="wp-block-group content relative">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    <!-- wp:paragraph -->
    <span class="block py-[30px] desktop:py-[60px] text-[36px] desktop:text-[60px] text-center font-bold" data-aos="fade-right" data-aos-offset="30">Poznaj inwestycję</span>
    <!-- /wp:paragraph -->
    ...
    <div class="wp-block-group test row-links mb-[50px] flex flex-wrap justify-center items-center gap-[20px]">
      ...
      <!-- /wp:paragraph -->
      <!-- wp:paragraph -->
      <a href="<?php echo home_url() . '/mieszkania' ?>" class="js-srebrniki-cookie text-[#8a8f99] hover:text-textGray" data-aos="fade-up" data-aos-offset="30">Lista mieszkań</a>
      <!-- /wp:paragraph -->
      <!-- wp:paragraph -->
  ...
  <div class="wp-block-group row-content-container px-[20px] desktop:px-0">
    ...
    <div class="wp-block-group row-content desktop:flex">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:px-[100px] desktop:w-1/2">
        <!-- wp:paragraph -->
        <span class="mb-[40px] text-[30px] desktop:text-[34px] leading-[36px] desktop:leading-[44px]" data-aos="fade-right" data-aos-offset="30">Osiedle Srebrniki to zielona enklawa położona na granicy dwóch dzielnic Gdańska - Wrzeszcza i Moreny</span>
        <!-- /wp:paragraph -->
        ...
        <div class="wp-block-group mb-[100px] desktop:grid grid-rows-2 grid-cols-2 gap-[30px]">
          ...
          <div class="wp-block-group info-box1 mb-[35px] desktop:mb-[30px]">
            <!-- wp:paragraph -->
            <span class="mb-[10px] uppercase text-[#8a8f99] text-[11px] tracking-[1px]" data-aos="fade-right" data-aos-offset="30">LOKALIZACJA</span>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">Gdańsk</span>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
          ...
          <div class="wp-block-group info-box2 mb-[35px] desktop:mb-[30px]">
            <!-- wp:paragraph -->
            <span class="mb-[10px] uppercase text-[#8a8f99] text-[11px] tracking-[1px]" data-aos="fade-right" data-aos-offset="30">TERMIN UKOŃCZENIA (BUDYNEK 1)</span>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">IV kwartał 2020</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box3 mb-[35px] desktop:mb-[30px]">
            ...
            <span class="mb-[10px] uppercase text-[#8a8f99] text-[11px] tracking-[1px]" data-aos="fade-right" data-aos-offset="30">LICZBA MIESZKAŃ W SPRZEDAŻY</span>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">450 w pierwszym etapie</span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          ...
          <div class="wp-block-group info-box4 mb-[35px] desktop:mb-[30px]">
            <!-- wp:paragraph -->
            <span class="mb-[10px] uppercase text-[#8a8f99] text-[11px] tracking-[1px]" data-aos="fade-right" data-aos-offset="30">POWIERZCHNIA MIESZKAŃ</span>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <span class="text-[24px]" data-aos="fade-right" data-aos-offset="30">27 m<sup>2</sup> - 113 m<sup>2</sup></span>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
        </div>
    ...
    <div class="wp-block-group row-content2 desktop:flex flex-row-reverse">
      ...
      <div class="wp-block-group mb-[40px] desktop:mb-0 desktop:p-[140px_100px] desktop:w-1/2">
        <!-- wp:paragraph -->
        <span class="mb-[40px] text-[30px] desktop:text-[34px] leading-[36px] desktop:leading-[44px]" data-aos="fade-right" data-aos-offset="30">Postaw na nowoczesną architekturę</span>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <span class="text-[18px] text-[#8a8f99]" data-aos="fade-right" data-aos-offset="30">W ofercie znajdują się przestronne i doświetlone mieszkania oraz lokale usługowe o wygodnych rozkładach z możliwością aranżacji według własnych potrzeb. W każdym budynku znajduje się cichobieżna winda. Mieszkania na parterze posiadają ogródki, a lokale położone na najwyższych piętrach widok na Zatokę Gdańską. Ofertę multimedialną na terenie osiedla zapewnia <a href="https://www.upc.pl/" class="inline relative before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[50%] hover:before:min-h-[100%] before:bg-[#b3f1ff] before:transition-height before:duration-300 before:ease before:z-[-1] cursor-pointer">https://www.upc.pl/</a></span>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
