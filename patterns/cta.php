  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] h-full">
    ...
    <div class="wp-block-group py-[60px] flex items-center justify-center">
      ...
      <div class="wp-block-group">
        <!-- wp:heading -->
        <h2><span class="block text-[28px] desktop:text-[38px] font-bold mb-[20px] desktop:mb-[40px]" data-aos="fade-right" data-aos-offset="30">Potrzebujesz więcej informacji?</span></h2>
        <!-- /wp:heading -->
