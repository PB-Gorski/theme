...
<div id="cta" class="wp-block-group cta h-fit relative">
  <!-- wp:image -->
  <figure class="wp-block-image w-full h-[560px] desktop:h-auto absolute left-0 top-0 z-[-1] scale-x-[-1] desktop:scale-[1]">
