...
<div>
  <!-- [submit "Submit"] -->
  <button type="submit" class="relative mx-auto bg-primaryRed px-[20px] text-white w-fit h-[55px] flex items-center justify-center before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#2e384d] before:transition-height before:duration-300 before:ease cursor-pointer" style="border-bottom:2px solid #95102b"><span class=" z-[1] relative">Wyślij</span></button>
</div>