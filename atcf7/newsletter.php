...
<div class="newsletter wrapper">
  <div class="mb-[30px] desktop:flex">
    ...
    <div>
      <!-- [submit "Submit"] -->
      <button type="submit" class="group relative bg-primaryRed text-white desktop:w-[170px] h-[60px] flex items-center justify-center before:content-[''] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-primaryRed before:transition-height before:duration-300 before:ease cursor-pointer"><span class="z-[1] relative">Zapisz się</span></button>
    </div>
  </div>
  <div class="flex">
