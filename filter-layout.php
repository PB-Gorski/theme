          ...
          if (get_taxonomy($select_term)->label == 'Cena') { ?>
            ...
            <div class="dropdown-filter flex-col bg-white">
              ...
              <div class="menu-active font-bold">
                <span class="arrow-down w-full active_window p-[10px_15px] desktop:p-[22px_15px] flex justify-between items-center">Wybierz<?php get_taxonomy($select_term)->label ?></span>
              </div>
