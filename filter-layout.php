...
<div id="<?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($c_target); ?>" class="filter-layout <?php echo esc_attr($ymc_filter_layout); ?> <?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($layout_id); ?> <?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($layout_id); ?>-<?php echo esc_attr($c_target); ?>">
  ...
  ?>
    ...
    <p class="js-oInwestycji js-foundedPostOnStart custom-posts-found1 text-textGray container mx-auto px-[20px] desktop:px-0 bg-white w-full flex items-center justify-center gap-[6px] desktop:text-center z-[0] absolute translate-x-[-50%] desktop:text-[24px] text-[18px] text-center" style="left:50%;width:100%;height:110px">test</p>
