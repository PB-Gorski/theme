    ...
    <div class="filter-entry" data-terms="<?php echo esc_attr($all_terms); ?>">
      ...
      foreach ($result_tax as $tax) {
        ...
        if (get_taxonomy($select_term)->label == 'Cena') {
          echo '
            <div class="dropdown-filter self-center mb-0 mt-[3px]">
            ...
            <div class="wp-block-group group dropdown-filter btn-search mt-[3px] relative bg-primaryRed text-white w-full desktop:w-[140px] h-[62px] flex items-center justify-center gap-[15px] before:content-[``] before:inline-block before:absolute before:bottom-0 before:left-0 before:w-full before:min-h-[0%] hover:before:min-h-[100%] before:bg-[#9C0927] before:transition-height before:duration-300 before:ease cursor-pointer">
              <p class=" z-[1]">
