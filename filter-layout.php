...
<div id="<?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($c_target); ?>" class="filter-layout <?php echo esc_attr($ymc_filter_layout); ?> <?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($layout_id); ?> <?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($layout_id); ?>-<?php echo esc_attr($c_target); ?>">
  ...
  ?>
    ...
    <div class="filter-entry container h-fit desktop:h-[120px] mx-auto justify-center" data-terms="<?php echo esc_attr($all_terms); ?>">
      <?php
      ...
      foreach ($result_tax as $tax) {
        ...
        if (get_taxonomy($select_term)->label == 'Cena') { ?>
          ...
          <div class="btn-wrapper bg-white h-[120px] flex items-center justify-center" style="width:167px;border-right:2px solid #ebeef2;border-bottom:2px solid #ebeef2">
          ...
          <div class="btn-search btn-wrapper bg-white h-[120px] flex items-center justify-center" style="width:167px;border-bottom:2px solid #ebeef2">
