...
<div id="<?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($c_target); ?>" class="filter-layout <?php echo esc_attr($ymc_filter_layout); ?> <?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($layout_id); ?> <?php echo esc_attr($ymc_filter_layout); ?>-<?php echo esc_attr($layout_id); ?>-<?php echo esc_attr($c_target); ?>">
  ...
  ?>
        ...
        foreach ($result_tax as $tax) {
          ...
          if (get_taxonomy($select_term)->label == 'Cena') { ?>
            <div class="dropdown-filter customPrice price-min flex-col bg-white">
              ...
              <div class="dropdown__value dropdown__value-price dropdown__value-min font-bold flex items-center after:content-['']"><span class="hidden"></span><input type="number" id="inputPriceMin" placeholder="Min" class="w-full"></div>
            ...
            echo '</div>';
            echo '</div>';
          } else  if (get_taxonomy($select_term)->name == 'metraz') { ?>
    ...
    <p class="js-oInwestycji text-textGray container mx-auto px-[20px] desktop:px-0 bg-white w-full flex items-center justify-center gap-[6px] desktop:text-center z-[0] relative translate-x-[-50%] desktop:text-[24px] text-[18px] text-center" style="left:50%;width:100%;height:110px"> </p>
