window.addEventListener("load", function() {
  ...
  function runSorting(){
    ...
    priceMaxValue = document.querySelector('.dropdown__value-max').childNodes[0].toString == 'Max' ? 10000000 : parseInt(document.querySelector('.dropdown__value-max').childNodes[0].innerHTML.split(' ').join(''));
