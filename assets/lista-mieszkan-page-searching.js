window.addEventListener("load", function() {
  ...
  if(document.body.classList.contains('post-type-archive-mieszkania')){
    ...
    function runSearchingPrice(){
      ...
      priceMinValue = document.querySelector('.dropdown__value-min').innerHTML == 'Max' ? 10000000 : parseInt(document.querySelector('.dropdown__value-min').childNodes[0].innerHTML.split(' ').join(''));
