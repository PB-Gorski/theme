    ...
    <div class="wp-block-group text-content container mx-auto desktop:px-0 px-[20px] desktop:pt-[100px] z-[2] relative">
      ...
      <div class="wp-block-group title-wrapper">
        ...
        <div class="wp-block-group title text-white text-[36px] desktop:text-[60px] font-bold mb-[20px] leading-[45px] desktop:leading-[70px]">
          <!-- wp:heading {"level":1} -->
          <h1>
            <span data-aos="fade-right" data-aos-offset="30">Osiedle Srebrniki - Zobacz dostępne mieszkania</span>
          </h1>
          <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group sub-title text-[24px] text-[#8a8f99]">
          <!-- wp:paragraph -->
          <p class="max-w-[550px] text-white opacity-[0.75]" data-aos="fade-right" data-aos-offset="30">
            Określ parametry, aby znaleźć mieszkanie dokładnie takie, jakiego
            potrzebujesz.
          </p>
          <!-- /wp:paragraph -->
        </div>
